...
`CLOSED_OR_ACCEPTED_BY_SAME_SHA_MANIFEST`. El registro versionado conserva `DEF-E6-01`, `DEF-E6-02`, `DEF-E6-03`, `DEF-E6-04`, `DEF-E6-05`, `DEF-E6-06`, `DEF-E6-07` y `DEF-E6-08` con su causa y regresión; su cierre efectivo y `EVD-E6-37/38` sólo los autoriza el manifiesto runtime del mismo SHA.
...
| `DEF-E6-08` | Validadores rechazan evidencia CI válida por rama vacía en checkout PR | P1 verificación/CI                   | EVD-E6-29/33/34/35/40; GATE-E6-02/03   | `ENV-E6-CI`; `SHA_BY_SAME_SHA_MANIFEST`    | Ejecutar Stage 6 sobre el commit merge detached de un pull request                     | Esperado: identificar la rama fuente; actual: `git branch --show-current` emitía vacío | `CHG-E6-10`; artefacto CI; canarios detached/PR         | Los productores dependían sólo de la rama Git actual y omitían las referencias seguras de GitHub | QA/CI   | `VERIFIED_BY_SAME_SHA_MANIFEST` | `SHA_BY_SAME_SHA_MANIFEST` | Node 24.19; PR/local/ref/detached + validadores | `STATUS_BY_SAME_SHA_MANIFEST` | `STATUS_BY_SAME_SHA_MANIFEST`; E6-02/03    |

El siguiente hallazgo usa `DEF-E6-09`. No crear IDs para bloqueos de autorización.
...
| `CHG-E6-10`        | Resolver la rama desde Git local o refs seguras de GitHub y cerrar `DEF-E6-08`       | Envelope compartido y evidencia perf      | Preflight, performance, security y full CI   | `SHA_BY_SAME_SHA_MANIFEST` | `STATUS_BY_SAME_SHA_MANIFEST` |
