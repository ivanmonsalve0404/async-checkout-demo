...
`CLOSED_OR_ACCEPTED_BY_SAME_SHA_MANIFEST`. El registro versionado conserva `DEF-E6-01`, `DEF-E6-02`, `DEF-E6-03`, `DEF-E6-04`, `DEF-E6-05` y `DEF-E6-06` con su causa y regresión; su cierre efectivo y `EVD-E6-37/38` sólo los autoriza el manifiesto runtime del mismo SHA.
...
El siguiente hallazgo usa `DEF-E6-07`. No crear IDs para bloqueos de autorización.
